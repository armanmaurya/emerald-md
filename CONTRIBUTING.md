# Emerald Contributing Guidelines

Thank you for your interest in contributing to Emerald! We welcome contributions from the community to help improve the project. Please read the following guidelines to ensure a smooth contribution process.

- [Code of Conduct](.github/CODE_OF_CONDUCT.md)

## Issue Reporting Guidelines

Please search for similar issues before creating a new one and always follow the [issue template.](.github/ISSUE_TEMPLATE/)
...
- Improve the UI
- Write tests for Emerald
- Share your thoughts! We want to hear about features you think are missing, any bugs you find, and why you :heart: Emerald.